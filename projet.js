...
const projects = [
  ...
  },
  {
    ...
    banner: "maquette-entreprise-banner.png",
    img: "maquette-entreprise-banner.png",
    desc: "Conception et simulation d'un réseau d'entreprise complet sous Cisco Packet Tracer, réalisé dans le cadre du module RSX101 (Réseaux et protocoles) en Licence Informatique au CNAM. La maquette simule une PME répartie sur deux sites : une quinzaine de postes, deux switches Cisco 2960, trois routeurs Cisco 2911, et deux serveurs. Le réseau est segmenté en trois VLANs (Administration, Comptabilité, Serveurs), avec un routage dynamique RIP entre les sites, un accès Internet via NAT, et des services DNS, messagerie et web hébergés en interne.",
    vision: "Rassembler dans une seule maquette toutes les notions vues en cours : VLANs, trunk, routage dynamique, DHCP, NAT, DNS, SSH. L'objectif était de construire un réseau cohérent et fonctionnel de bout en bout — qu'un poste du site 2 puisse obtenir son IP automatiquement, communiquer avec un poste du site 1 dans un autre VLAN, résoudre un nom de domaine, et atteindre Internet.",
    stack: ["Cisco Packet Tracer 9.0", "Cisco IOS", "Cisco 2911", "Cisco 2960", "RIP", "VLAN", "NAT", "DHCP"],
    features: [
      "Topologie deux sites : Site 1 (SW-01 + postes Administration) et Site 2 (SW-02 + postes Comptabilité/portables), reliés par un lien trunk 802.1Q",
      "Segmentation en 3 VLANs : VLAN 10 Administration (192.168.10.0/24), VLAN 20 Comptabilité (192.168.20.0/24), VLAN 30 Serveurs (192.168.30.0/24)",
      "Routage inter-VLAN et inter-sites via trois routeurs Cisco 2911 configurés avec RIP — propagation automatique des routes",
      "Service DHCP configuré sur le routeur principal — attribution automatique des adresses IP, passerelle et DNS pour chaque poste",
      "NAT sur le routeur de bordure pour la translation des adresses privées vers Internet (lien WAN 10.0.0.0/30)",
      "Serveur DNS résolvant les noms internes (lecnam.com), hébergeant également une messagerie et un site web",
      "Administration à distance sécurisée des switches via SSH",
      "Tests complets validés : DHCP, ping inter-VLAN, ping Internet (8.8.8.8), résolution DNS, accès SSH"
    ],
    link: "#"
  },
  {
